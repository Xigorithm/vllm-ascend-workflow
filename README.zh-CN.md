...
本仓库将 AI 编码助手转化为 vllm-ascend 领域专家，通过可复用的 Agent Skills、技术文档和开发会话记录，系统性地加速 vllm-ascend 开发全流程。
...
| Skill | 说明 | 触发示例 | 推荐 |
|:------|:-----|:---------|:-----|
| **feature-learning** | 生成中文技术学习文档，包含 Mermaid 架构图、GPU vs NPU 对比分析、源码逐行走读 | `我想了解 vllm-ascend 的 ACL Graph` | ⭐⭐⭐⭐⭐ |
